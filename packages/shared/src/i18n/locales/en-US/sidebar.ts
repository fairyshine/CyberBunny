export default {
  ...
  'sidebar.agent.mindUserPrompt': 'Mind User Prompt',
  'sidebar.agent.mindUserPromptPlaceholder': 'Define how this agent behaves when the mind tool makes it act as the user',
  'sidebar.agent.chatActiveAssistantPrompt': 'Chat Active Assistant Prompt',
  'sidebar.agent.chatActiveAssistantPromptPlaceholder': 'Define how this agent behaves when the chat tool makes it proactively contact another agent',
  ...
  'sidebar.agent.contacts': 'Contacts',
  'sidebar.agent.noContacts': 'No contacts yet',
  'sidebar.agent.contactSameGroup': 'Same Group',
  'sidebar.agent.contactLinked': 'Linked',
  'sidebar.agent.contactNetworkConnected': 'Network Connected',
  'sidebar.agent.openAgentSessions': "View this agent's sessions",
  'sidebar.agent.contactChat': 'Start Chat',
  'sidebar.agent.contactChatRunning': 'Starting chat...',
  'sidebar.agent.contactChatPrompt': 'Enter the objective or opening message for {{name}}',
  'sidebar.agent.contactChatFinished': 'Finished the chat conversation with {{name}}',
  'sidebar.agent.contactChatError': 'Failed to start chat: {{error}}',
