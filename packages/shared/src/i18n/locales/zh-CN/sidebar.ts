export default {
  ...
  'sidebar.agent.mindUserPrompt': 'Mind 用户 Prompt',
  'sidebar.agent.mindUserPromptPlaceholder': '定义该智能体在 mind 工具里扮演挑剔用户时的说话方式',
  'sidebar.agent.chatActiveAssistantPrompt': 'Chat 主动 Assistant Prompt',
  'sidebar.agent.chatActiveAssistantPromptPlaceholder': '定义该智能体在 chat 工具里主动联系其他智能体时的行为方式',
  ...
  'sidebar.agent.contacts': '通讯录',
  'sidebar.agent.noContacts': '暂无联系人',
  'sidebar.agent.contactSameGroup': '同组',
  'sidebar.agent.contactLinked': '已链接',
  'sidebar.agent.contactNetworkConnected': '网络已连接',
  'sidebar.agent.openAgentSessions': '查看该智能体会话',
  'sidebar.agent.contactChat': '发起 Chat',
  'sidebar.agent.contactChatRunning': 'Chat 发起中...',
  'sidebar.agent.contactChatPrompt': '输入发送给 {{name}} 的对话目标或开场白',
  'sidebar.agent.contactChatFinished': '已完成与 {{name}} 的 Chat 对话',
  'sidebar.agent.contactChatError': 'Chat 发起失败：{{error}}',
