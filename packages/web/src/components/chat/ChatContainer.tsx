...
import { getOpenAITools, parseToolCallArguments, convertArgumentsToInput, generateOpenAISystemPrompt } from '@shared/services/tools/openai-format';
import { getOpenAISkills, generateSkillsSystemPrompt } from '@shared/services/skills/openai-format';
import { getAnthropicTools, generateAnthropicSystemPrompt } from '@shared/services/tools/anthropic-format';
import { getAnthropicSkills } from '@shared/services/skills/anthropic-format';
import { Message } from '@shared/types';
import { useLLM } from '@shared/hooks/useLLM';
import { logLLM, logTool } from '@shared/services/console/logger';
import { LLMConversation } from '@shared/services/llm/conversation';
